...
const CoreServices = () => {
  ...
  const services = [
    {
      ...
      description:
        "Modern, responsive websites with clean UI, fast performance, and SEO-ready structure",
      ...
      highlight: "Website",
      links: "/services/website-development",
    },
    {
      icon: FaSearch,
      title: "SEO Optimization Services",
      description:
        "Data-driven SEO strategies to improve search rankings, increase organic traffic, and boost online visibility",
      ...
      highlight: "SEO",
      links: "/services/seo-optimization",
    },
    {
      icon: FaCode,
      title: "Custom Software Development",
      description:
        "Tailored solutions built with modern technologies to accelerate your business growth",
      ...
      links: "/services/software-development",
    },
    {
      icon: FaServer,
      title: "Enterprise Management Systems",
      description:
        "Comprehensive business management solutions for seamless operations",
      ...
      links: "/services/enterprise-systems",
    },
    {
      icon: FaMobileAlt,
      ...
      highlight: "Mobile",
      links: "/services/mobile-app-development",
    },
    {
      icon: FaBrain,
      title: "AI & Machine Learning",
      description:
        "Intelligent solutions powered by AI/ML to drive innovation and efficiency",
      ...
      borderGradient: "from-green-500/50 to-emerald-500/50",
      highlight: "AI/ML",
      links: "/services/ai-ml",
    },
    {
      icon: FaCloud,
      title: "Cloud Solutions & Migration",
      description:
        "Seamless cloud infrastructure and migration with enterprise-grade security",
    ...
    // },
    {
      ...
      description:
        "24/7 technical support and maintenance for uninterrupted operations",
  ...
  const getServiceDetails = (service) => {
    const serviceDetailsMap = {
      "Custom Software Development": {
        ...
        process: [
          ...
          },
          {
            ...
            description:
              "Create system architecture, database design, and UI/UX mockups",
          },
          {
            title: "Development & Testing",
            description:
              "Agile development with regular sprints, code reviews, and testing",
          },
          {
            title: "Deployment & Launch",
            description:
              "Deploy to production environment with monitoring and optimization",
          },
          {
        ...
        process: [
          {
            ...
            description:
              "Define app concept, create wireframes and design mockups",
          },
          {
            title: "Development",
          ...
          },
          {
            ...
            description:
              "Prepare and submit to Apple App Store and Google Play",
          },
          {
            title: "Launch & Updates",
            description:
              "Launch app and provide regular updates and maintenance",
          },
        ],
        links: [
          {
        ...
        process: [
          {
            ...
            description:
              "Assess current infrastructure and plan migration strategy",
          },
          {
      ...
      "Digital Transformation": {
        ...
        description:
          "Complete digital transformation consulting to modernize your business",
        icon: "🚀",
        image:
        ...
        process: [
          {
            ...
            description:
              "Assess current state and develop transformation strategy",
          },
          {
      ...
      "Database Management": {
        ...
        description:
          "Robust database solutions with optimization and backup strategies",
        icon: "🗄️",
        image:
        ...
        process: [
          {
            ...
            description:
              "Assess current database and identify optimization opportunities",
          },
          {
        ...
        process: [
          {
            title: "Assessment & Planning",
            description:
              "Assess current processes and plan automation strategy",
          },
          {
      ...
      "Digital Consulting": {
        ...
        description:
          "Strategic technology consulting to optimize your digital transformation journey",
        icon: "💡",
        image:
          "https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg?auto=compress&cs=tinysrgb&w=1200",
        processingTime: "2-8 weeks",
  ...
  const visibleServices = isMobile
    ? services.slice(0, mobileVisibleCount)
    : services;
          ...
          {[
            {
              ...
              y: 20,
              trail: "red",
              path: "M15,20 Q50,10 85,30 Q50,50 15,20",
            },
            {
              icon: FaServer,
              x: 85,
              y: 25,
              trail: "pink",
              path: "M85,25 Q50,15 15,35 Q50,55 85,25",
            },
            {
              icon: FaCloud,
              x: 20,
              y: 70,
              trail: "purple",
              path: "M20,70 Q60,50 80,80 Q40,90 20,70",
            },
            {
              icon: FaShieldAlt,
              x: 80,
              y: 75,
              trail: "blue",
              path: "M80,75 Q40,55 20,85 Q60,95 80,75",
            },
            {
              icon: FaBrain,
              x: 50,
              y: 15,
              trail: "red",
              path: "M50,15 Q20,40 50,65 Q80,40 50,15",
            },
            {
              icon: FaRocket,
              x: 50,
              y: 85,
              trail: "pink",
              path: "M50,85 Q80,60 50,35 Q20,60 50,85",
            },
          ].map((item, i) => (
            <div key={i}>
              {/* Animated Trail */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Comprehensive IT solutions designed to{" "}
            <span className="bg-red-500/20 px-2 py-1 rounded-lg font-semibold text-red-300 border border-red-400/30">
              accelerate
            </span>{" "}
            your business growth and{" "}
            <span className="bg-pink-500/20 px-2 py-1 rounded-lg font-semibold text-pink-300 border border-pink-400/30">
              digital transformation
            </span>{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 gap-y-16 sm:gap-16 lg:gap-20 justify-items-center">
          {visibleServices.map((service, index) => (
            ...
            >
              ...
              >
                ...
                <motion.div
                  className="absolute inset-0 border border-red-400/30 rounded-3xl pointer-events-none"
                  animate={{
                    opacity: [0.3, 0.7, 0.3],
                  }}
                  transition={{
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${service.bgGradient} opacity-0 group-hover:opacity-20 transition-opacity duration-300 rounded-3xl pointer-events-none`}
                ></div>
                ...
                <motion.div
                  className="mt-6 flex items-center justify-center text-red-300 font-semibold group-hover:text-red-200 transition-colors duration-300 cursor-pointer relative z-10"
                  whileHover={{ x: 5 }}
                  transition={{ duration: 0.2 }}
                  onClick={() => navigate(service.links)}
                >
                  <button className="cursor-pointer">Explore Service</button>
                  <motion.div
                    animate={{ x: [0, 3, 0] }}
                    transition={{
                      duration: 2,
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 ">
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2 w-full  ">
            ...
            >
              ...
              <motion.button
                onClick={openModal}
                className="px-8 py-4 text-[14px] md:text-base bg-gradient-to-r from-red-500 to-pink-500 text-white font-bold rounded-xl hover:shadow-2xl hover:shadow-red-500/40 transition-all duration-300 flex items-center gap-2 mx-auto group border border-red-400/30"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
                Get Started Today

              ...
              >
                <Link
                  ...
                  className={`flex items-center px-6 py-4 transition-all duration-200 group relative overflow-hidden ${
                    isActive 
                      ? 'text-red-600 bg-gradient-to-r from-red-50 to-pink-50' 
                ...
                >
                  ...
                  {/* Hover Background */}
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-r from-red-500/5 to-pink-500/5 opacity-0 group-hover:opacity-100"
                    initial={{ x: "-100%" }}
                    whileHover={{ x: 0 }}
                    transition={{ duration: 0.2 }}
                  />
                  ...
                  {isActive && (
                    <motion.div
                      className="absolute left-0 top-1/2 w-1 h-6 bg-gradient-to-b from-red-500 to-pink-500 rounded-r-full"
                      initial={{ scaleY: 0 }}
                      animate={{ scaleY: 1 }}
                      transition={{ duration: 0.2 }}
                    />
